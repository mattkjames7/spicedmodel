...
void ANNPTModel::ModelCart(int n, float *x, float *y, float *smr,
			bool ShowDC, bool OnlyDC, bool Validate, int m0, int m1, bool RevTrans, float *out) {
 ...
 * 
 * ********************************************************************/
void ANNPTModel::Model(int n, float *mlt, float *R, float *smr, bool ShowDC, bool OnlyDC, 
