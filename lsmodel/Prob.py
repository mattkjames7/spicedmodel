import numpy as np
from ._CFunctions import _CgetAvProb,_CgetAvProbCart,_CgetScaledProb,_CgetScaledProbCart
from ._CTConv import _CTConv

def Prob(x,y,SMR=None,Coord='xy',ShowDC=True,OnlyDC=False,Validate=True,m=[1,3]):
	'''
	Get the probability (of a point being within the PS) model output 
	...
	=======
	out : float
		Array containing the probability that the positions are within
		the plasmasphere.
	'''
