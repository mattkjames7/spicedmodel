import numpy as np
from ._CFunctions import _CgetAvPT,_CgetAvPTCart,_CgetScaledPT,_CgetScaledPTCart
from ._CTConv import _CTConv

def PT(x,y,SMR=None,Coord='xy',ShowDC=True,OnlyDC=False,Validate=True,m=[1,3],RevTrans=True):
	'''
