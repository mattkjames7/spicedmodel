 ...
 * NAME : ANNPTModel(ptr)
 * 
 * DESCRIPTION : Constructor of the ANNPTModel object.
 * 
 * INPUTS : 
 ...
 * 
 * ********************************************************************/
ANNPTModel::ANNPTModel(unsigned char *ptr) {
 ...
 * NAME : ~ANNPTModel()
 * 
 * DESCRIPTION :Destructor for the ANNPTModel object
 * 
 * 
 * ********************************************************************/
ANNPTModel::~ANNPTModel() {
 ...
 * 
 * OUTPUTS : 
 * 		float	*out		The plasma trough electron density.
 * 
 * 
 * ********************************************************************/
void ANNPTModel::ModelCart(int n, float *x, float *y, float *smr,
 ...
 * 
 * ********************************************************************/
void ANNPTModel::Model(int n, float *mlt, float *R, float *smr, 
						bool ShowDC, bool OnlyDC, bool Validate, 
						int m0, int m1, bool RevTrans, float *out){
