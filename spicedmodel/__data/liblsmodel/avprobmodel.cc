...
/***********************************************************************
 * NAME : AvProbModel(ptr)
 * 
 * DESCRIPTION : Constructor of the AvProbModel object.
 * 
 * INPUTS : 
 ...
 * 
 * ********************************************************************/
void AvProbModel::DC(int n, float *R, float *dc) {

	int i;
	for (i=0;i<n;i++) {
		dc[i] = -1.0/(1.0 + expf(-dc_[0]*(R[i] - dc_[1]))) + 1.0;
	}
}
